...
class Test_ccc_Module(unittest.TestCase): 
    ...
    def test_cm_basic(self):
        ...
        self.assertTrue(cm_value is not None)
        self.assertTrue(isinstance(cm_value, float))
        self.assertEqual(cm_value, pytest.approx(0.01, abs=0.01))
